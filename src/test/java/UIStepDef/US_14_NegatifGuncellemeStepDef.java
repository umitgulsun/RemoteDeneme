 ...
 Thread.sleep(3000);
    ...
    public void dahaOnceOlusturulanSsnNoluKişiListedenBulunurVeSatırdakiEditButonunaTiklar(String arg0) throws InterruptedException {
        ...
        for (int i = 0; i < sayfaSayisi; i++) {
            rowliste = MyRemoteDriver.getRemoteDriver().findElements(By.cssSelector(".table-responsive table tr"));
            ...
            Driver.clickWithJS(MyRemoteDriver.getRemoteDriver().findElement(By.xpath("(//ul[@class='d-flex justify-content-end pe-3 pagination']//a)[3]")));
