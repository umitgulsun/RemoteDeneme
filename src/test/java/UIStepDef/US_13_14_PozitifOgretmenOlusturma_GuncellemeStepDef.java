...
public class US_13_14_PozitifOgretmenOlusturma_GuncellemeStepDef {
    ...
    Actions actions = new Actions(MyRemoteDriver.getRemoteDriver());
    ...
    public void ogretmenin_olustugunu_dogrular() throws InterruptedException {
      ...
      //  assert (sonSayfa.containsAll(ogretmenlist));
    }
    ...
    public void submitTusunaBasipDogrulamaYapar() throws InterruptedException {
        ...
        Thread.sleep(2000);
        List<WebElement> rowListe = MyRemoteDriver.getRemoteDriver().findElements(By.cssSelector(".table-responsive table tr"));
        Thread.sleep(2000);
        for (WebElement w:rowListe) {
            if (w.getText().contains(phone)) {
         //       assert (w.getText().contains(phone));
                break;
            }
        }
    }
    ...
    public void setupDriver(String arg0, String arg1) {
        MyRemoteDriver.getRemoteDriverSetup(arg1, MyRemoteDriver.getOptions(arg0));
    }
